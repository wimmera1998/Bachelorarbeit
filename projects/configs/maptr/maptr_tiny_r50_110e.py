...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_infos_temporal_train-v1.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'nuscenes_infos_temporal_val-v1.pkl',
             map_ann_file=data_root + 'nuscenes_map_anns_val-v1.json',
